    ...
    return (
        <>
            ...
            <section className="w-1/2 text-center mx-auto text-[#2f4a69] font-[Roboto] text-xl my-3 mb-8">
                ...
                <div>
                    ...
                    <div className="mt-8">
                        ...
                        <span>База риболовлі та сімейного відпочинку Деметра
                           знаходиться на лівому березі басейну річки Південний Буг між селами Піски та Гурʼївка, близько 25 км від Миколаєва.<br/>
                            Це місце приваблює риболовів та поцінувачів тихого та культурного відпочинку
                           <br/> Вас чекають комфортабельні номери, затишок і тиша.
                       </span>
                    </div>
            </section>
            <section className="font-[Poppins] text-xl text-center h-auto mx-auto bg-slate-200 text-[#2f4a69] pb-16 pt-16">
                ...
                <p>
                    Південний Буг це найриболовніша річка України, яка приваблює не тільки аматорів та початківців рибної
                    ...
                    Найпопулярнішими видами хижої риби є щука, окунь та судак, з мирних видів в основному, водиться карась,
                    лящ, плітка та сазан.<br/>Надалі ми будемо вас тримати в курсі останніх новин риболовлі та спійманих трофеїв.<br/>

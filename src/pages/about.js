        ...
        <section className="w-1/2 mx-auto text-[#2f4a69] font-[Roboto] text-xl my-3 mb-8">
            ...
            <div className="mt-8">
                <p className="indent-8">
                       ...
                       Досвідчений єгер допоможе вам спіймату саму велику рибу, яка є у водоймі, якщо фарт буде на вашому боці.
                </p>
                <p className="indent-8">
                    Наша Деметра облаштована всім необхідним для вашого відпочинку, це не тільки номери, обладнані
                    свіжим ремонтом,
                    але й ланшафтний дизайн для комфортних прогулянок. А саме головне це природа та краєвиди, які можна
                    побачи тільки у нас.
